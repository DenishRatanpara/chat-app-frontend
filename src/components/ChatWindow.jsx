...
const ChatWindow = ({
    ...
    (e) => {
      try {
        ...
        switch (data.type) {
          ...
          case "typing":
            // Only update typing indicator if the event comes from the other user.
  ...
  // Poll the online status every 10 seconds.
  useEffect(() => {
  ...
  const handleInputChange = (e) => {
    ...
    if (ws.current?.readyState === WebSocket.OPEN) {
      ...
      // Clear typing after 0.5 seconds of inactivity.
      typingTimeoutRef.current = setTimeout(() => {
        ws.current.send(
          JSON.stringify({
            type: "typing",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div ref={messagesEndRef} />
        {isTyping && (
          <div className="absolute bottom-2 left-4 text-sm text-gray-600 flex items-center">
